"""
Django settings for wispy_hall_dev_63540 project.
...
ROOT_URLCONF = 'wispy_hall_dev_63540.urls'
...
WSGI_APPLICATION = 'wispy_hall_dev_63540.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_hall_dev_63540 API",
    "DESCRIPTION": "API documentation for wispy_hall_dev_63540 App",
    "VERSION": "v1",
}
